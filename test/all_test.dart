...
LocalFileSystem lfs = const LocalFileSystem();

Directory viewsDir = lfs.directory('test/views');
  ...
  group('cache', () {
    ...
    if (angel.isProduction) {
      test('should be used in production mode', () async {
          ...
          await lfs.file('$cachePath/after.mustache').copy('$cachePath/cache.mustache');

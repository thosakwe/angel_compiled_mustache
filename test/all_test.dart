...
Future main() async {
  ...
  await angel.configure(compiled_mustache(new Directory('./test/views'), defaultLayout: 'raw'));
  ...
  group('layouts', () {
    Angel angel = new Angel();
    setUp(() async {
      await angel.configure(compiled_mustache(new Directory('./test/views')));
    });
    ...
    test('should respect user-set default layout', () async {
      Angel ang = new Angel();
      await ang.configure(compiled_mustache(new Directory('./test/views'), defaultLayout: 'other'));
